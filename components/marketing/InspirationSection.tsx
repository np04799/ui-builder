...
function PpcNoirFashionThumb() {
  return (
    <svg viewBox="0 0 280 160" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',height:'100%'}}>
      <defs>
        <linearGradient id="ig-noir-hero-grad" x1="0" y1="0" x2="0" y2="1">
        ...
        <linearGradient id="ig-noir-img" x1="0" y1="0" x2="1" y2="1">
      ...
      <rect y="21" width="280" height="82" fill="url(#ig-noir-img)"/>
      ...
      <rect y="21" width="280" height="82" fill="url(#ig-noir-hero-grad)"/>
